...
function remote_init(manufacturer, model)
	if model=="BaseII" then
		local items={
			...
			{name="Slider 1", input="value", min=0, max=127, output="value"}, --4 (index#: used for offset for creating Slider names for LCD)
...
function remote_prepare_for_use()
	...
	local retEvents={
		...
		remote.make_midi("F0 00 01 61 11 29 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 F7"),
